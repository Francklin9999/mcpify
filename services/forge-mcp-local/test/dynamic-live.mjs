...
process.env.FORGE_USE_REAL_BROWSER = "0"; // test the managed STEALTH-MAX path, not the auto real-Chrome attach
process.env.MCP_BROWSER_HEADLESS = "1"; // headless so the gated run doesn't open a window (STEALTH MAX is headful by default)
