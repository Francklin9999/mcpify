...
/**
 * Confidence is a contract invariant: always in [0,1] (`01 §5`). The schema rejects out-of-range;
...
/**
 * Aggregate a server's confidence from its per-tool confidences (`01 §5`, single source of truth).
